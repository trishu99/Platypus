    ...
    render(){
        return(
            ...
            <View style={styles.container}>
               <ScrollView>
                <Text style={styles.header}>Start a program</Text>
				<TextInput
					style={styles.input}
					placeholder='enter cmd to run program'
					value={this.state.programname}
					onChangeText={this.handleOnChangeProgramName}
				/>
                <Button 
                    title='Run'
                    onPress={this.StartProgram}
                />
                <Text>{this.state.startpoutput}</Text>



                <Text style={styles.header}>Stop or Terminate Process</Text>
				<TextInput
					style={styles.input}
					placeholder='Process Name'
					value={this.state.processnameforterminate}
					onChangeText={this.handleOnChangeProcessNameForTerminate}
				/>
                <TextInput
					style={styles.input}
					placeholder='Process ID'
					value={this.state.pid_t}
					onChangeText={this.handleOnChangePidT}
				/>

                <Button 
                    title= 'Stop or Terminate'
                    onPress={this.downloadEmployeeData}
                />
                <Text>{this.state.output}</Text>


                <Text style={styles.header}>Signal Process</Text>
				<TextInput
					style={styles.input}
					placeholder='Process Name'
					value={this.state.processnameforsignal}
					onChangeText={this.handleOnChangeProcessNameForSignal}
				/>
                <TextInput
					style={styles.input}
					placeholder='Process ID'
					value={this.state.pid_s}
					onChangeText={this.handleOnChangePidS}
				/>
                <Button 
                    title= 'Send Signal'
                    onPress={this.sendsignal}
                />
                <Text>{this.state.signaloutput}</Text>



                <Text style={styles.header}>Check if process is running or not</Text>
				<TextInput
					style={styles.input}
					placeholder='Process Name'
					value={this.state.programnameforcheck}
					onChangeText={this.handleOnChangeProgramNameForCheck}
				/>
                <Button 
                    title='Run'
                    onPress={this.checkprocess}
                />
                <Text>{this.state.checkoutput}</Text>
