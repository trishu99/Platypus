	...
	render() {
		return (
			<View style={styles.container}>
				<ScrollView>
                <Text>No of Logical Cores</Text>
                <Text> {this.state.logicalCores} </Text>

                <Text>No of Physical Cores</Text>
                <Text> {this.state.physicalCores} </Text>
                
                <Text>CPU Utilization Percentage</Text>
                <Text> {this.state.cpuPercent}</Text>
